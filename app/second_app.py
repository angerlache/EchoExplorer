...
def process_on_second_machine():
    ...
    if AI == 'BatML':
        ...
        os.chdir('../BirdNET')
        subprocess.run("source /home/batmen/anthony/myenv/bin/activate && {} {} {} {} {} {} {} {} && rm -rf samples/{}/ && rm results/{}".format("python3", "analyze.py", "--i", "samples/"+username+'/', '--o', 'results/'+username+'/', '--rtype', 'csv',username,username + '/' + "BirdNET.results.csv"), shell=True, check=True)
        ...
        subprocess.run("source /home/batmen/anthony/myenv/bin/activate && {} {} {} {} {} {} && rm -rf samples/{}/".format("python3", "bat_ident.py", "--i", "samples/"+username, '--o', 'results/'+username,username), shell=True, check=True)
        ...
        os.chdir('../batdetect2')
        subprocess.run("source /home/batmen/anthony/myenv/bin/activate && {} {} {} {} {} && rm -rf samples/{}/ ".format("python3", "run_batdetect.py", "samples/"+username, "results/"+username, 0.5, username), shell=True, check=True)
        os.chdir('../app')
